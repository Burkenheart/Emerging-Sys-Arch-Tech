...
#    1.1    Completed Milestone 3 TODOs:
#           - Implemented Morse code state machine
#           - Added red (dot) and blue (dash) LED control
#           - Added Morse timing delays
#           - Implemented SOS/OK message toggle via button
#           - Added LCD message display updates
#           - Completed graceful shutdown and GPIO cleanup
# ------------------------------------------------------------------
