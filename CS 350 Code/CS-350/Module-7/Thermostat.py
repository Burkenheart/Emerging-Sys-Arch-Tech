...
#    2.0        Completed final thermostat functionality including
#               state machine control, GPIO button interrupts, LED
#               indicators, LCD output, AHT20 temperature monitoring,
...
class TemperatureMachine(StateMachine):
    ...
    def manageMyDisplay(self):
        ...
        while not self.endDisplay:
            ...
            lcd_line_1 = current_time.strftime(
                "%m/%d %H:%M:%S"
            ) + "\n"
            ...
            if altCounter < 6:
                ...
                lcd_line_2 = (
                    f"Temp: {floor(self.getFahrenheit())} F"
                )
            ...
            if (counter % 30) == 0:
                ...
                ser.write(
                    self.setupSerialOutput().encode("utf-8")
                )
