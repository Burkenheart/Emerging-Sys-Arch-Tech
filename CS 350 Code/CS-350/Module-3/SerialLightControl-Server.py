...
#    2          Completed LED control and GPIO cleanup logic
# ------------------------------------------------------------------
...
# Make sure the LED begins in the OFF state when the program starts
...
while repeat:
    ...
    try:
        ...
        #
        # The strip method removes newline and whitespace characters so
        # commands such as "on\n" will correctly match the "on" state.
        ...
        match command:
            case "off":
                ...
                # Turn off the LED connected to GPIO line 18
                GPIO.output(18, False)
            ...
            case "on":
                ...
                # Turn on the LED connected to GPIO line 18
                GPIO.output(18, True)
            ...
            case "exit" | "quit":
                ...
                # Make sure the LED is turned off before exiting
                GPIO.output(18, False)

                # Release the GPIO resources used by this program
                GPIO.cleanup()

                # End the loop without using a break statement
                repeat = False
...
# Close the serial port after the main loop ends
ser.close()